...
const edartPayProdectdsSlice = createSlice({
...
export const { testreducer } = edartPayProdectdsSlice.actions;
export default edartPayProdectdsSlice.reducer;
